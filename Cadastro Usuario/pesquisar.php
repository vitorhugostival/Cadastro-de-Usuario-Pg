...
<body>
    ...
    $sql = "SELECT id_usuario, nivel_usuario, nome_usuario, sobrenome, funcao, logi, senha FROM usuario WHERE nome_usuario LIKE $1";
    $result = pg_query_params($conexao, $sql, array($pesquisar));  // Executa a consulta com o parâmetro
